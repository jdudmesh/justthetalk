...
class HomeController {
	...
	*/
	...
	def charter = {
		...
		render view: "charter", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def help = {
		...
		render view: "help", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def policy = {
		...
		render view: "policy", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def terms = {
		...
		render view: "terms", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def donations = {
		...
		render view: "donations", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def genderidentity = {
		...
		nav.breadcrumbs = [ [link:false, controller:"", action:"", text:"Gender Identity Posting Policy"] ]
		render view: "gender", model: [nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def bio = {
		...
		render view: "bio", model:[user:user, discussionSubs:discussionSubs, folderSubs:folderSubs, nav: nav, folders: Folder.listOrderByDescription()]
	}
	...
	def user = {
		...
		if(!user) {
			...
			render view: "user", model:[user:user, nav: nav, modNotes: modNotes, logins: logins, history: history, sockpuppets: sockpuppets, folders: Folder.listOrderByDescription()]
		}
	...
	def addModNote = {
		...
		redirect2 action:"user", id:user.username
	...
	def switchview = {
		...
		if(params.view == "normal") {
			cookie = new Cookie("use_normal_view", "yes")
		}
		else if(params.view == "mobile") {
			cookie = new Cookie("use_normal_view", "no")
		}
		cookie.setPath("/")
	...
	def worldview = {
		...
		nav.breadcrumbs = [ [link:false, controller:"", action:"", text:"World View"] ]
		render view: "worldview", model:[user:user, nav: nav, folders: Folder.listOrderByDescription()]
	}
