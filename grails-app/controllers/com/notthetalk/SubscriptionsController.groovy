...
class SubscriptionsController {
	...
	def check = {
		...
		if(updatedDiscussions.size()) {
			redirect2 controller: "discussion",action: "check", id: updatedDiscussions[0].discussionId
		}
		else {
	...
	def checkAjax = {
		...
		updatedDiscussions.each {
			w << discussionTagLib.renderDiscussionTitle(it, 50, true, false)
		}
