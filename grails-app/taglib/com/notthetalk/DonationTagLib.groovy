...
class DonationTagLib {
	...
	def donationFrontPage = { attrs, body ->
		...
		def cssClass = "btn-default"
		switch(vars.donationStatus) {
			case 1:
		...
		b.div(id: "donate") {
			a(href: g.createLink(controller:"home", action:"donations"), class:"btn btn-sm $cssClass", id:"donatebutton", "Support JUSTtheTalk")
		}
