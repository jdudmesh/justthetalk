...
class GuardianHeadlinesJob {
	...
	def processPage(start) {
		...
		def url = "http://content.guardianapis.com/search?tag=tone%2fnews&page=$start&page-size=50&from-date=$fromDate&to-date=$toDate&show-fields=headline,trailText&format=json&api-key=hjck27n4fad6vhdcujcxxmfz"
